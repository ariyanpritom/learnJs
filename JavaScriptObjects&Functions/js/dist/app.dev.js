...
var Person = function Person(name, yearOfBirth, job) {
  this.name = name;
...
jack.calculateAge(); // Object create
...
console.log(args); // Return function
...
var teacherQuestion = interviewQuestion("programmer")("Marry"); // IIFE
...
outerFunction("Ariyan")("Pritom"); // Bind, Call, Apply
